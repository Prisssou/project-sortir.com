 ...
 */
final class Version20200214085221 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE place ADD zipcode VARCHAR(10) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE place DROP zipcode');
    }
}
